...
def create_app():
    ...
    with app.app_context():
        ...
        # Attach the database directly to the Flask app instance, instead of
        # reaching into routes.py / socket_events.py to set a module-level
        # variable. This way, any file that has access to the running app
        # (via `current_app`) can reach the database through `app.db`.
        app.db = db
